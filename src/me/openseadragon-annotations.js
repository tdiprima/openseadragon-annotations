...
(OpenSeadragon.Viewer = OpenSeadragon.Viewer || {}),
    ...
    (OpenSeadragon.Viewer.prototype.annotations = (function (e) {
        function t(i) {
  ...
  \****************************/,
        function (e, t, n) {
            ...
            var c = (function () {
                ...
                d = i(s),
                f = { mode: "MOVE", zoom: 1, width: 0, height: 0, activityInProgress: !1, annotations: [] },
                h = (function (e) {
                    function t() {
  ...
  \***********************************/,
        function (e, t, n) {
            "use strict";
            function i(e, t, n) {
                t.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }), n.getMode() !== e && t.dispatch({ type: "MODE_UPDATE", mode: e });
            }
        ...
        function (e, t, n) {
            !(function (e, n) {
                        ...
                        if ("class" !== t || o)
                            if ("style" === t) {
                                if (((!n || c(n) || c(i)) && (e.style.cssText = n || ""), n && "object" == typeof n)) {
                                    if (!c(i)) for (var r in i) r in n || (e.style[r] = "");
                                ...
                                l(n)
                                    ? d
                                        ...
                                        : e.removeAttribute(t)
                                    : "object" == typeof n || a(n) || (d ? e.setAttributeNS("http://www.w3.org/1999/xlink", H(d[1]), n) : e.setAttribute(t, n));
                            }
                        else e.className = n || "";
                }
                function w(e, t, n) {
                ...
                function B(e, t, n, i, o) {
                    ...
                    return (
                        t.children && 1 === t.children.length && "string" == typeof t.children[0] && 1 === s.childNodes.length && s.firstChild instanceof Text
                            ? (s.firstChild.nodeValue = t.children[0])
                            : (t.children || s.firstChild) && T(s, t.children, n, i),
                        Z(s, t.attributes),
                        r && r.ref && (s[ee].ref = r.ref)(s),
                        l && (ce = !1),
                        s
                    );
                }
                function T(e, t, n, i) {
                    ...
                    if (f) for (var m in d) d[m] && (s[(h = A++)] = d[m]);
                    h < A && k(s);
                }
                function k(e, t) {
                ...
                function Z(e, t) {
                    ...
                    if (t) for (var o in t) (o in n && t[o] == n[o] && (("value" !== o && "checked" !== o) || t[o] == e[o])) || v(e, o, t[o], n[o], ce);
                }
                function Q(e) {
                ...
                function W(e, t, n, i, o) {
                    var r = e.base;
                    e._disableRendering ||
                        ((e._disableRendering = !0),
                        (e.__ref = t.ref) && delete t.ref,
                        (e.__key = t.key) && delete t.key,
                        u(r) || o ? e.componentWillMount && e.componentWillMount() : e.componentWillReceiveProps && e.componentWillReceiveProps(t, i),
                        i && i !== e.context && (e.prevContext || (e.prevContext = e.context), (e.context = i)),
                        e.prevProps || (e.prevProps = e.props),
                        (e.props = t),
                        (e._disableRendering = !1),
                        0 !== n && (1 !== n && !1 === q.syncComponentUpdates && r ? S(e) : C(e, 1, o)),
                        e.__ref && e.__ref(e));
                }
                function C(e, t, o) {
                    if (!e._disableRendering) {
                        ...
                        if (
                            (p &&
                                ...
                                (e.state = f),
                                (e.context = h),
                                2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(u, l, s) ? (r = !0) : e.componentWillUpdate && e.componentWillUpdate(u, l, s),
                                (e.props = u),
                                (e.state = l),
                                (e.context = s)),
                ...
                function J(e, t, n, i) {
                    ...
                    return (
                        !c || (i && !o._component)
                            ? (o && !a && (P(o, !0), (e = r = null)), (o = V(t.nodeName, u, n)), e && !o.nextBase && (o.nextBase = e), W(o, u, 1, n, i), (e = o.base), r && e !== r && ((r._component = null), x(r)))
                            : (W(o, u, 3, n, i), (e = o.base)),
                        e
                    );
                }
                function P(e, t) {
                ...
                h = (function () {
                    function e(t) {
                        ...
                        o(this, e),
                            ...
                            (this.btn = new a.Button((0, a.extend)({ onClick: this.onClick }, t))),
  ...
  \************************************/,
        function (e, t, n) {
            "use strict";
            function i(e) {
                e.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }), e.dispatch({ type: "ANNOTATIONS_RESET", annotations: [] });
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
        } /*!***************************************!*\
  ...
  \***************************************/,
        function (e, t, n) {
            "use strict";
            function i(e, t) {
                t.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 }), t.dispatch({ type: "ANNOTATIONS_RESET", annotations: e });
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
        } /*!***********************************!*\
  ...
  \***********************************/,
        function (e, t, n) {
            "use strict";
            function i(e, t) {
                t.dispatch({ type: "INITIALIZE", options: e });
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
        } /*!*****************************!*\
  !*** ./src/actions/zoom.js ***!
  \*****************************/,
        function (e, t, n) {
            "use strict";
            function i(e, t) {
                t.dispatch({ type: "ZOOM_UPDATE", zoom: e });
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
        } /*!***************************************!*\
  ...
  \***************************************/,
        function (e, t, n) {
            ...
            var l =
                ...
                R = { xmlns: "http://www.w3.org/2000/svg", version: "1.1", preserveAspectRatio: "none", viewBox: "0 0 100 100", width: "100%", height: "100%" },
                N = { cursor: "default", "background-color": "rgba(0,0,0,0)" },
                U = (function () {
                    var e = function (e) {
                        ...
                        s(t, [
                            {
                                key: "getInitialState",
                                value: function () {
                                    return { annotations: h.default.getAll() };
                                },
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    h.default.addHandler("CHANGE_EVENT", function () {
                                        e.setState({ annotations: h.default.getAll() });
                                    });
                                },
                            },
                            {
  ...
  \************************************/,
        function (e, t, n) {
            ...
            function i(e, t) {
                switch (t.getMode()) {
                    case "DRAW":
                        e.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !1 });
                }
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
        } /*!*****************************!*\
                ...
                switch (i.getMode()) {
                    case "DRAW":
                        if (i.isActivityInProgress()) {
                            ...
                            if (o && "path" === o[0]) {
                                var r = o[1].d;
                                n.dispatch({ type: "ANNOTATIONS_UPDATE_LAST", update: { d: r + " L" + e + " " + t } });
                            }
                        }
                }
            }
  ...
  \******************************/,
        function (e, t, n) {
            ...
            function i(e, t, n, i) {
                switch (i.getMode()) {
                    case "DRAW":
                        n.dispatch({ type: "ACTIVITY_UPDATE", inProgress: !0 }), n.dispatch({ type: "ANNOTATIONS_CREATE", annotation: o.getPath(e, t) });
                }
            }
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = i);
            var o = {
                getPath: function (e, t) {
                    return ["path", { fill: "none", d: "M" + e + " " + t, stroke: "red", "stroke-width": 3, "stroke-linejoin": "round", "stroke-linecap": "round", "vector-effect": "non-scaling-stroke" }];
                },
            };
        } /*!********************************!*\
  ...
  \******************************/,
        function (e, t, n) {
            ...
            var c = n(/*! ./Control */ 5),
                ...
                m = (function (e) {
                    function t() {
                        return o(this, t), r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, { Tooltip: "Draw", srcRest: g.default, srcGroup: s.default, srcHover: f.default, srcDown: p.default }));
                    }
                    return a(t, e), t;
                })(u.default);
            t.default = m;
  ...
  \******************************/,
        function (e, t, n) {
            ...
            var c = n(/*! ./Control */ 5),
                ...
                m = (function (e) {
                    function t() {
                        return o(this, t), r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, { Tooltip: "Move", srcRest: g.default, srcGroup: s.default, srcHover: f.default, srcDown: p.default }));
                    }
                    return a(t, e), t;
                })(u.default);
            t.default = m;
  ...
  \*********************/,
        function (e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.clean = t.set = t.get = void 0);
            ...
            (a.default.Viewer.prototype.initializeAnnotations = function (e) {
                var t = this,
                    ...
                    i = function () {
                        ...
                        (0, m.default)({ zoom: a, width: u.width, height: u.height }, h.default),
                            N.forEach(function (e) {
                                t.addControl(e.btn.element, { anchor: r.ControlAnchor.BOTTOM_LEFT });
                            }),
                            D && (t.removeHandler("open", D), (D = null)),
                            (U = !0),
                            e && e();
                    };
  ...
  \******************************/,
        function (e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.convertHeight = t.convertWidth = void 0);
                        ...
                        return (
                            ...
                            (e.prototype.waitFor = function (e) {
                                ...
                                for (var t = 0; t < e.length; t++) {
                                    var n = e[t];
                                    this._isPending[n]
                                        ? this._isHandled[n] || ("production" !== i.env.NODE_ENV ? r(!1, "Dispatcher.waitFor(...): Circular dependency detected while waiting for `%s`.", n) : r(!1))
                                        : (this._callbacks[n] || ("production" !== i.env.NODE_ENV ? r(!1, "Dispatcher.waitFor(...): `%s` does not map to a registered callback.", n) : r(!1)), this._invokeCallback(n));
                                }
                            }),
